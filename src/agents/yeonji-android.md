...
<!-- knowledge: mobile/android.md, mobile/kotlin.md -->
<!-- human-in-loop: false -->
...
- `knowledge/mobile/android.md` — MVVM, Compose, Hilt, Navigation, Networking, Storage, Material 3, testing
- `knowledge/mobile/kotlin.md` — null safety, coroutines, sealed classes, extension functions, idiomatic patterns
...
4. Apply all standards from `knowledge/mobile/android.md`:
   - Hilt for DI
