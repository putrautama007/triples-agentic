...
<!-- knowledge: mobile/ios.md, mobile/swift.md -->
<!-- human-in-loop: false -->
...
- `knowledge/mobile/ios.md` — SwiftUI, MVVM, navigation (NavigationStack), networking, storage, Apple HIG compliance, testing
- `knowledge/mobile/swift.md` — optionals, value/reference types, async/await, error handling, protocols, API design guidelines
...
5. Apply all standards from `knowledge/mobile/ios.md`:
